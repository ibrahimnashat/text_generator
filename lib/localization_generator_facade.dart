...
import 'package:text_generator/console_Ui/printer.dart';
import 'package:text_generator/file_manager.dart';
import 'package:text_generator/json_string_adapter.dart';
import 'package:text_generator/text_map_builder.dart';
...
class LocalizationJsonFacade {
  ...
  void generateLocalizationFile() {
    ...
    try {
      ...
      bar.updateIndexAndDesc(88, localizationContent);
